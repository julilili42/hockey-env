...
\begin{itemize}[itemsep=1pt, topsep=2pt]
    ...
    \item A three-stage curriculum strategy~\cite{bengio2009curriculum} 
      that combines scripted opponents with self-play to mitigate 
      non-stationarity and improve generalization.
